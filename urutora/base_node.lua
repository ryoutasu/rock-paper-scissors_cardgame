...
function base_node:up()
	self.textAlign = utils.textAlignments.UP
	return self
end

function base_node:middle()
	self.textAlign = utils.textAlignments.MIDDLE
	return self
end

function base_node:down()
	self.textAlign = utils.textAlignments.DOWN
	return self
end
...
function base_node:drawText(color)
	...
	if self.textAlign == utils.textAlignments.UP then
		y = math.floor(self.py)
	elseif self.textAlign == utils.textAlignments.DOWN then
		y = math.floor(self.py + self.nph - utils.textHeight(self))
	end
